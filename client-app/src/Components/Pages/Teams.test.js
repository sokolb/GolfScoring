...
describe("Teams Tests", () => {
        ...
        teams: [
          {
            teamNumber: 1,
            teamMemberIds: [
              "3b1823f4-b36c-4288-1111-ed0b00bc6653",
              "0c6b559a-ae1b-44d1-2222-d7f3f8b9e44a",
            ],
          },
          {
            teamNumber: 2,
            teamMemberIds: [
              "3b1823f4-3333-4288-a827-ed0b00bc1111",
              "0c6b559a-4444-44d1-9c8b-d7f3f8b92222",
            ],
          },
        ],
        players: [
  ...
  describe("Player Selection Box", () => {
    ...
    it("Selection box is populated with players on page load", () => {
      ...
      expect(playerSelectionBox.props().children[0].key).toEqual(
        "3b1823f4-b36c-4288-1111-ed0b00bc6653"
      );
      expect(playerSelectionBox.props().children[0].props.children).toEqual(
        "Brian Sokoloski"
      );

      expect(playerSelectionBox.props().children[1].key).toEqual(
        "0c6b559a-ae1b-44d1-2222-d7f3f8b9e44a"
      );
      expect(playerSelectionBox.props().children[1].props.children).toEqual(
        "Bob Smith"
      );

      expect(playerSelectionBox.props().children[2].key).toEqual(
        "0c6b559a-ae1b-44d1-2222-d7f3f8b1111"
      );
      expect(playerSelectionBox.props().children[2].props.children).toEqual(
        "Mary Johnson"
      );
    });
  ...
  it("Submit buttons calls addTeam with correct parameters", () => {
    ...
    console.log(JSON.stringify(playerSelectionBox.props()));
    playerSelectionBox.simulate("change", createEvent("SomeValueHere"));
